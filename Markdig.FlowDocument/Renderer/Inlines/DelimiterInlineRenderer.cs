...
namespace Markdig.FlowDocument.TextBlock.Inlines
{
    ...
    public class DelimiterInlineRenderer : TextBlockObjectRenderer<DelimiterInline>
    {
        protected override void Write(FlowDocumentRenderer renderer, DelimiterInline obj)
        {
        }
    }
}