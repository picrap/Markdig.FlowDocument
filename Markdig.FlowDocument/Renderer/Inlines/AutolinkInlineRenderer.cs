...
namespace Markdig.FlowDocument.TextBlock.Inlines
{
    ...
    public class AutolinkInlineRenderer : TextBlockObjectRenderer<AutolinkInline>
    {
        protected override void Write(FlowDocumentRenderer renderer, AutolinkInline autolinkInline)
        {
        }
    }
}